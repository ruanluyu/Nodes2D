boolean connectable(NodePoint np1, NodePoint np2) {
    return typeConnectable(np1.getType(), np2.getType());
  }
/**
...
class NodePoint extends NObject {
  ...
  private ArrayList<NodeLine> outLinesList = new ArrayList<NodeLine>();
